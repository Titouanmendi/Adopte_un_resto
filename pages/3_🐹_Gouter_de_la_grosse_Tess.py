...
from utils import convert_words_to_emojis, district_list_Tess, lieu_mapping3
...
df = pd.read_csv("data/gouter_Tess.csv")
...
lieu_value = lieu_mapping3[lieu]
if lieu_value != "Partout":
    df = df[df[lieu_value]]

district = st.sidebar.multiselect("Arrondissement", options=df_districts, default=district_list_Tess)
...
if show_map:
    ...
    st.markdown("### Liste des endroits à goûter")
